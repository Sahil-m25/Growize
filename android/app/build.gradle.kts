...
// ── Release-signing key.properties loader ───────────────────────────────
// Reads android/key.properties (not committed). If absent, release builds
// fall back to debug signing so `flutter run --release` still works for
// development.
