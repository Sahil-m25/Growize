...
final investorRepositoryProvider = Provider<InvestorRepository>(
  (_) => InvestorRepository(),
);
final projectsRepositoryProvider = Provider<ProjectsRepository>(
  (_) => ProjectsRepository(),
);
final financialsRepositoryProvider = Provider<FinancialsRepository>(
  (_) => FinancialsRepository(),
);
...
final loginEventsRepositoryProvider = Provider<LoginEventsRepository>(
  (_) => LoginEventsRepository(),
);
...
final myLoginEventsProvider = FutureProvider<List<Map<String, dynamic>>>((
  ref,
) async {
  ref.watch(authStateProvider);
...
final currentInvestorProvider = FutureProvider<Map<String, dynamic>?>((
  ref,
) async {
  ref.watch(authStateProvider);
